        ...
        return (
          <div className="text-center space-y-6">
            ...
            <p className="text-sm text-gray-600 leading-relaxed font-light">
              Welcome to{" "}
              <span className="font-bold text-black">Nayab Watches</span>, your
              premier destination for luxury and sport timepieces. We are
              dedicated to providing the finest selection of watches that
              combine elegance with durability. Our mission is to deliver
              quality and style to your wrist.
            </p>
            <div className="flex justify-center gap-6 pt-2 text-[10px] uppercase font-bold tracking-widest text-gray-400">
              <span>Authentic</span> • <span>Reliable</span> •{" "}
              <span>Luxury</span>
            </div>
          </div>
        );
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <p className="text-sm text-gray-600 font-light">
              ...
              available on WhatsApp to assist you.
            </p>
            <a
        ...
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              By using our website, you agree to our terms. We ensure that all
              products are authentic. Prices are subject to change without
              notice. We reserve the right to cancel orders if products are out
              of stock or pricing errors occur.
            </p>
          </div>
        );
      case "Returns":
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed bg-yellow-50 p-4 border border-yellow-200 rounded-sm">
              You are allowed to open the parcel and inspect the product upon
              receipt. Please make the payment only after you are satisfied. If
              you find any fault at that moment, you may request a return or
              exchange immediately, and your product will be replaced. The
              company will not be responsible for any claims made afterwards.
            </p>
          </div>
        );
      case "Shipping":
        return (
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-600 leading-relaxed bg-blue-50 p-4 border border-blue-200 rounded-sm space-y-2">
              ...
              <p>
                After depositing the shipping fee into our account, please
                forward the payment screenshot to our support team on WhatsApp;
                otherwise, your order will not be confirmed.
              </p>
              <p>
                You will receive your delivery within{" "}
                <span className="font-bold">3 to 7 working days</span>.
              </p>
              <p className="text-xs italic">
                Kindly coordinate with our delivery rider. Thank you.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-4 text-center">
            ...
            <p className="text-xs text-green-600 font-bold mt-2">
              Get Rs. 500 OFF on select items!
            </p>
          </div>
        );
      case "Tracking":
        return (
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-gray-600">
              Please contact our support team to track your order.
            </p>
            <a
              href={`https://wa.me/${whatsappNumber}`}
              target="_blank"
  ...
  return (
    <>
      <footer className="bg-[#f9f9f9] text-[#333] pt-16 pb-8 font-sans border-t border-gray-200">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-y-12 gap-x-4 md:gap-8 mb-12">
            {/* 1. HELP */}
            <div>
              <h3 className="font-bold text-sm uppercase mb-6 tracking-wider">
                Help
              </h3>
              <ul className="space-y-4 text-sm text-gray-600">
                ...
                <li>
                  <button
                    onClick={() => setActivePopup("Returns")}
                    className="hover:text-black transition-colors text-left"
                  >
                    Returns & Exchanges
                  </button>
                ...
                <li>
                  <button
                    onClick={() => setActivePopup("Shipping")}
                    className="hover:text-black transition-colors text-left"
                  >
                    Shipping & Delivery
                  </button>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-600">
                ...
                <li>
                  <Link
                    href="/Products"
                    className="text-[#d95e00] hover:text-red-700 transition-colors"
                  >
                    Sale
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-600">
                ...
                <li>
                  <button
                    onClick={() => setActivePopup("Tracking")}
                    className="hover:text-black transition-colors text-left"
                  >
                    Orders Tracking
                  </button>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex flex-wrap border-t border-l border-gray-200 max-w-[193px]">
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/nayabwatch/"
                  target="_blank"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/nayab_watch/"
                  target="_blank"
                  className="w-12 h-12 flex items-center justify-center border-r border-b border-gray-200 bg-[#f9f9f9] text-black hover:bg-black hover:text-white transition-all duration-300"
                >
                  <svg
                ...
                {/* YouTube */}
                <a
                  href="https://www.youtube.com/@nayabwatch"
                  target="_blank"
                  className="w-12 h-12 flex items-center justify-center border-r border-b border-gray-200 bg-[#f9f9f9] text-black hover:bg-black hover:text-white transition-all duration-300"
                >
                  <svg
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@nayabwatch.com"
                  target="_blank"
                  className="w-12 h-12 flex items-center justify-center border-r border-b border-gray-200 bg-[#f9f9f9] text-black hover:bg-black hover:text-white transition-all duration-300"
                >
                  <svg
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="bg-black text-white px-4 py-2 font-serif text-xl tracking-widest border border-black cursor-pointer">
              Nayab{" "}
              <span className="block text-[8px] text-center tracking-[0.2em] -mt-1 text-gray-300">
                WATCHES
              </span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex gap-2 opacity-60 grayscale hover:grayscale-0 transition-all cursor-default">
                ...
                <span className="text-[10px] font-bold text-gray-600 border border-gray-400 px-1 rounded-sm">
                  CASH ON DELIVERY
                </span>
              ...
              <button
                onClick={scrollToTop}
                className="bg-[#666] hover:bg-[#444] text-white w-10 h-10 flex items-center justify-center rounded-sm transition-colors shadow-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      {activePopup && (
        ...
        >
          <div
            className="bg-white p-8 rounded-lg max-w-md w-full relative shadow-2xl"
